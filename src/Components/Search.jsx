...
const Search = () => {
  ...
  const onSubmit = (event) => {
     ...
     console.log(event)
    navigate.navigate('/search' ,{state :{searchParams}})
  };
            ...
            render={({ field }) => (
              <FormItem className="flex items-center space-y-0">
                ...
                <FormControl>
                  <Input 
                  placeholder="From"
                   className="focus-visible:ring-0 md:text-base focus-visible:ring-transparent focus-visible:ring-offset-0 border-none  px-1"  {...field} />
                </FormControl>
              </FormItem>
            )}
          />
