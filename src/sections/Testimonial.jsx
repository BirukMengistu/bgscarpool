...
const Testimonial = () => {
  const feedback = [
    ...
    {
      desc: "Ever since I started using Bgs-Ride, my daily commute has transformed into a seamless and enjoyable experience. The convenience and reliability of this app have truly exceeded my expectations. The user-friendly interface makes booking a ride a breeze.",
      img: "https://dummyimage.com/106x106",
      user: "G_clan",
      prof: "Sen. Cybersecurity"
    },
    {
      ...
      img: "https://dummyimage.com/106x106",
      user: "Sen_M",
      prof: "Sen Backend  and Test automation"
    }
  ]
  return (
